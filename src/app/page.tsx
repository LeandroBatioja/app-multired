    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-gray-800">Mis archivos</h2>
        </div>
        <div className="flex items-center gap-3">
          <button
        ...
        <>
          ...
          {folders.length === 0 && files.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 text-lg">No hay archivos aún</p>
              <p className="text-gray-400 text-sm mt-1">Sube tu primer archivo o crea una carpeta</p>
            </div>
          )}
        </>
      )}
